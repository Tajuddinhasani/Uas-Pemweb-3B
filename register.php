<?php
include "admin/connect.php"; // Pastikan file ini memuat koneksi ke database
...
if(isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO users (username, password, phone) VALUES ('$username', '$hashedPassword', '$phone')";
    $result = mysqli_query($conn, $query);

    if($result) {
        echo "Registrasi berhasil. Silakan <a href='/login.html'>masuk</a>.";
    } else {
