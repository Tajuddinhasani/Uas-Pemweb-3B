            ...
            <ul class="navbar-nav float-right">
              ...
              <li class="nav-item dropdown">
                ...
                >
                  ...
                  <?php
                  if (isset($_SESSION['username'])) {
                    echo '<span>Hallo,</span><span class="text-dark">' . $_SESSION['username'] . '</span><i data-feather="chevron-down" class="svg-icon"></i>';
                  }
                  ?>
                  </span>
                </a>
                ...
                >
                  ...
                  <?php
                  if ($loggedIn) {
                    echo '<a class="dropdown-item" href="?logout"><i data-feather="power" class="svg-icon mr-2 ml-1"></i>Logout</a>';
                  }
                  ?>
                </div>
              </li>
